...
export class Productos_ProvService {
  ...
  getproductosPorCantidad(parametros_reposicion: any): Observable<any>{    
    return this.http.post<any>(this.apiUrl +"/getproductosporcantidad", parametros_reposicion);
  }
  
  getproductosPorFecha(parametros_reposicion: any): Observable<any>{    
    return this.http.post<any>(this.apiUrl +"/getproductosporfecha", parametros_reposicion);
  }
