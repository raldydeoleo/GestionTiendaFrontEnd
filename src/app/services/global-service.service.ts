...
export class GlobalService{
  constructor(private sanitizer: DomSanitizer, private loaderService: SpinnerLoaderService, private http: HttpClient, @Inject('BASE_URL') private baseUrl: string, private accountService: AccountService, private modalService: ModalService, private router: Router, private toast: ToastrService) {}
  ...
  getBlob(resourceUrl: string, parms: any = null, directPrintingChecked?:boolean, isCigarLabel?:boolean ) {
