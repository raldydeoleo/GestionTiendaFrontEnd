...
export class ProductosService {
  ...
  /*updateCantidad(producto: IProductos): Observable<IProductos>{
    return this.http.put<IProductos>(this.apiUrl +"/updatecantidad", producto);    
  }*/

  updateCantidad(parametros_reposicion: any): Observable<any>{    
    return this.http.post<any>(this.apiUrl +"/updatecantidad", parametros_reposicion);
  }

  compraProducto(parametros_compra: any): Observable<any>{
    return this.http.put<any>(this.apiUrl + "/compra", parametros_compra);
  }
